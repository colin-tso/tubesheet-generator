...
describe('Validating TubeSheet objects', () => {
  test('Testing creating new TubeSheet objects', () =>
  ...
  describe('Validation of 30° layout', () => {
    const args_base = [40, 95.3, (95.3 + 20) / 95.3, 30]
    const args_shellIDnull = [...args_base, 12]
    const args_minTubesnull = [...args_base, null]
  ...
  describe('Validation of 60° layout', () => {
    const args_base = [40, 95.3, (95.3 + 20) / 95.3, 60]
    const args_shellIDnull = [...args_base, 5]
    const args_minTubesnull = [...args_base, null]
    const expectedTubeField = [
      {
        x: closeTo(0, 6),
  ...
  describe('Validation of 45° layout', () => {
    const args_base = [40, 95.3, (95.3 + 20) / 95.3, 45]
    const args_shellIDnull = [...args_base, 10]
    const args_minTubesnull = [...args_base, null]
    const expectedTubeField = [
      {
  ...
  describe('Validation of radial layout', () => {
    const args_base = [40, 95.3, (95.3 + 20) / 95.3, 'radial']
    const args_shellIDnull = [...args_base, 15]
    const args_minTubesnull = [...args_base, null]
    const expectedTubeField = [
      {
        x: closeTo(0, 6),
